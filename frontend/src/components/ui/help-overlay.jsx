...
import {Search, Download, FileDown, CheckCircle, X, Moon} from 'lucide-react';
            ...
            {isVisible && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] sm:max-h-[80vh] overflow-y-auto"
                            ...
                            <div className="space-y-6 sm:space-y-8">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        content: "Switch between light and dark mode using the theme toggle button in the bottom left. Your preference will be saved automatically for future visits."
                                    }
                                ].map((section, index) => (
                                    <motion.section
                                        key={section.title}
